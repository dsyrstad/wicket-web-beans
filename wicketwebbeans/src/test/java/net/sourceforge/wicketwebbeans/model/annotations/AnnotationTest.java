...
public class AnnotationTest extends TestCase
{
    ...
    public void testContext()
    {
        ...
        ElementInfo[] expectedProps = { 
            ...
            new ElementInfo("beans", true, null, null, "Beans", null),
            new ElementInfo("firstName", false, null, null, "First Name", null),
            new ElementInfo("EMPTY:28", true, EmptyField.class.getName(), null, "", null),
            ...
            new ElementInfo("result", true, null, null, "Result", null),
            new ElementInfo("inlineBean", true, BeanInlineField.class.getName(), null, "Inline Bean", null),
            new ElementInfo("palette", true, null, AnnotationTestBean.ColorEnum.class.getName(), "Palette", null),
            new ElementInfo("dateTimestamp", true, null, null, "Date Timestamp", null),
            new ElementInfo("blockBean", true, BeanGridField.class.getName(), null, "Block Bean", null),
            new ElementInfo("description", true, TextAreaField.class.getName(), null, "Description", null),
